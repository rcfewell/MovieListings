...
- (instancetype) initWithTheater: (NSString *) theater
{
...
- (void)viewDidLoad
{
    ...
    NSString *moviesURLString = @"http://www.cs.sonoma.edu/~rfewell/movies/dbInterface.py?rType=moviesAtTheater&rTheater=";
    moviesURLString = [moviesURLString stringByAppendingString:self.theater];
    moviesURLString = [moviesURLString stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
